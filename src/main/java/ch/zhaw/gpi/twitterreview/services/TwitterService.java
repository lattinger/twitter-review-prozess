...
*
* @Service stellt sicher, dass diese Klasse beim Starten der Applikation als Bean generiert wird (wie bei @Component und @Bean), aber als Service gekennzeichnet ist
 * @author Laura
 */
